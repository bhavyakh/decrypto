class Periodic:
    ...
    def decrypt(cls, message, key=None):
        ...
        Args:
            message (str): encrypted number

        Returns:
            dict: {"A1Z26" : [output]}
        """
        try:
            atom = cls._atom(message)
            atom = atom.lower()
        except:
            atom = "N/A"
        return {"Periodic": atom}
